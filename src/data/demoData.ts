...
export const demoContests: Contest[] = [
  {
    id: "contest1",
    title: "Graphics Challenge #1",
    description: "Test your computer graphics skills with rendering challenges.",
    ...
    problems: [
      {
        ...
        description: "Implement a rasterization algorithm to render a triangle.",
        difficulty: "easy",
        points: 100,
        testCases: [
          { input: "vertices: (0,0), (10,0), (5,10)", output: "triangle rendered" },
          { input: "vertices: (0,0), (5,5), (10,0)", output: "triangle rendered" },
        ],
      },
      {
        id: "p2",
        title: "Lighting Model Implementation",
        description: "Implement Phong or Blinn-Phong lighting model.",
        difficulty: "medium",
        points: 200,
        testCases: [
          { input: "light_pos, normal, view_dir", output: "lit_color" },
          { input: "ambient, diffuse, specular", output: "combined" },
        ],
      },
      {
        id: "p3",
        title: "Ray Tracing Optimization",
        description: "Optimize ray tracing using BVH acceleration structures.",
        difficulty: "hard",
        points: 300,
        testCases: [
          { input: "ray, bvh_tree", output: "intersection_found" },
          { input: "scene_data, rays", output: "traced_image" },
        ],
      },
    ],
  },
  {
    ...
    description: "Build mobile applications with real-world features.",
  ...
  {
    id: "contest3",
    title: "Data Mining Challenge #2",
    description: "Advanced data mining and machine learning challenges.",
